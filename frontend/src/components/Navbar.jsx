...
const VolumeOffIcon = ({ className = "w-5 h-5" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const MessageIcon = ({ className = "w-8 h-8" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white/90 backdrop-blur-sm shadow-lg sticky top-0 z-50 border-b border-indigo-100">
          ...
          <div className="flex items-center gap-1 bg-gray-100 p-1 rounded-xl">
            {navLinks.map((link) => {
              ...
              return (
                <button
                  key={link.to}
                  onClick={() => setCurrentRoute(link.to)}
