...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-gray-900 to-blue-900 text-white flex justify-center items-center p-4">
      <div className="w-full max-w-4xl h-[90vh] bg-gray-900/90 backdrop-blur-sm rounded-2xl shadow-2xl flex flex-col overflow-hidden border border-gray-700">
        {/* Header */}
